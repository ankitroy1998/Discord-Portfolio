    ...
    <div className='bg-[#303238] h-screen'>
        ...
        <div className='bg-[#2B2C30] w-[500px] h-[250px] ml-20 mt-20 rounded-md'>
          <div className='absolute ml-4 mt-4'>
            ...
            <h1 className='text-white text-sm mt-2'>I completed my MCA from Netaji Subhash Engineering College, Kolkata</h1>
            <h1 className='text-white text-sm mt-2'>Affiliated under MAKAUT university.</h1>
            <h1 className='text-white text-sm mt-2'>Session : 2016 - 2019</h1>
            <h1 className='text-white text-sm mt-2'>CGPA : 9.58</h1>
          </div>
        </div>
    </div>
  )
